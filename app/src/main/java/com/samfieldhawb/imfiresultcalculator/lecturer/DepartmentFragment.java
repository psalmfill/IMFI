...
public class DepartmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String department  = getArguments().getString(LecturerHomeActivity.DEPARTMENT);
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_department, container, false);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference().child("Departments").child(department);
        departmmentsRv =  view.findViewById(R.id.department_rv);
        getData();
        departmentList = new ArrayList<>();
        departmentsAdapter = new DepartmentsAdapter(getContext(), departmentList);
