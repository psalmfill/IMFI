 ...
 */
public class SemesterFragment extends Fragment implements OnClickListener {
    ...
    private String faculty, department,level;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = firebaseDatabase.getReference().child("Semesters");
    ...
    public void onClick(String value) {
        ...
        intent.putExtra(LecturerHomeActivity.SEMESTER,value);
